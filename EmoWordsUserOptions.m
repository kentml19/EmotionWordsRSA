function userOptions = EmoWordsUserOptions()
%
...
userOptions.betaPath = 'C:\Users\kentml19\Desktop\Research\Postdoc\1_fMRI\rsatoolbox-develop\EmoWordsData';% e.g. /imaging/mb01/lexpro/multivariate/ffx_simple/[[subjectName]]/[[betaIdentifier]]
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	userOptions.maskPath = 'C:\Users\kentml19\Desktop\Research\Postdoc\1_fMRI\rsatoolbox-develop\EmoWordsData';%'/imaging/mb01/lexpro/multivariate/ffx_simple/[[subjectName]]/[[maskName]].img';
...
%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	%% %% %% %% %%
		...
		userOptions.structuralsPath = 'C:\Users\kentml19\Desktop\Research\Postdoc\1_fMRI\rsatoolbox-develop\EmoWordsData ';% e.g. /imaging/mb01/lexpro/[[subjectName]]/structurals/
